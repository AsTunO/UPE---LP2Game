...
static void GameWindow(ScreenSettings *configs, Food *fruit, Texture2D backTexture, Texture2D iconTexture);
static void TitleWindow(ScreenSettings *configs, Texture2D snakeBackTexture);
static void UpdateMenu(ScreenSettings *configs);
...
void TitleWindow(ScreenSettings *configs, Texture2D snakeBackTexture)
{
    ...
    // IMAGE
    DrawTexture(snakeBackTexture, GetScreenWidth() / 2 + 300, 100, WHITE);
...
void UpdateMenu(ScreenSettings *configs) {
